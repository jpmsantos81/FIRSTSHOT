...
* Destaques em amarelo e laranja;
* Tipografia moderna;
* Banner com texto alinhado à esquerda;
* Cards com sombras e bordas suaves;
* Modal com imagem posicionada à esquerda e descrição à direita;
* Logo ajustada para manter boa proporção;
...
* Carousel para apresentar as versões do jogo;
* Modal para exibir informações detalhadas dos jogadores;
* Accordion para organizar as curiosidades;
* Navbar fixa para facilitar a navegação entre as seções;
